        ...
        <>
            ...
            >
                <AccordionItem value="item-1">
                    <AccordionTrigger className={'text-xl font-bold'}>Avaliações</AccordionTrigger>
                                    ...
                                    <HoverCardContent className="w-80 rounded-full">
                                        <div className="flex justify-between items-center gap-4">
                                            ...
                                            <div className="space-y-1">
                                                ...
                                                <div className="flex gap-7 text-muted-foreground underline text-xs">
                                                    {testemunha.data}
                                                    ...
                                                    <Badge variant={'outline'}>
                                                        {[...Array(5)].map((_, i) => (
                                                            <Star
                                                                key={i}
                                                                className="w-4 h-4"
                                                                fill={i < testemunha.stars ? "yellow" : "none"}
                                                            />
                                                        ))}
                                                    </Badge>
